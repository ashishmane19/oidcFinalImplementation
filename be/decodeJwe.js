...
async function jweDecoding() {
 ...
 const { plaintext, protectedHeader } =  jose.compactDecrypt(jwe, privateKey)
...
// **********************using crypto cipher method *************

// initVector='MW2UJvylFnM_9f9U1QUcJA'
//     const decipher = crypto.createDecipheriv('aes-256-gcm', privateKey, initVector);

//     let decryptedData = decipher.update(jwe, "hex", "utf-8");
